...
public class LobbyNetwork_Mgr : MonoBehaviour
{
    ...
    public delegate void DLT_Respon(bool IsOk);
    [HideInInspector] public DLT_Respon DltMethod = null;
    string ClearDataUrl = "";
    ...
    void Start()
    {
        ...
        ClearDataUrl = "http://typhoon.dothome.co.kr/ClearData.php";
